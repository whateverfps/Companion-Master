...
export function inspectDrawingRegistryRuntime({ activeProject = null, documents = [], analyses = [], query = '' } = {}) {
  ...
  return {
    ...
    matchingRecords: matchingRecords.map(record => ({ drawingId: record.drawingId, projectId: record.projectId, documentId: record.documentId, drawingSetId: record.drawingSetId, sheetId: record.sheetId, sheetNumber: record.sheetNumber, normalizedSheetNumber: normalizeRegisteredSheetNumber(record.normalizedSheetNumber || record.sheetNumber), sheetTitle: record.sheetTitle, pageNumber: record.pageNumber })),
