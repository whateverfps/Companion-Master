...
export function enrichPageConstructionObjects(input={}) {
  ...
  const categoryCounts=Object.fromEntries(['Rooms','Equipment','Finishes','Doors','Windows','Schedules','Callouts','Symbols'].map(category=>[category,0]));for(const object of objects)categoryCounts[diagnosticCategory(object.objectType)]+=1;
